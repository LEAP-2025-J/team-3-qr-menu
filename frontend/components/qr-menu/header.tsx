...
export function Header({ restaurantName, restaurantDescription, tableNumber }: HeaderProps) {
  ...
  return (
    <div 
      ...
      style={{
        backgroundImage: "url('https://res.cloudinary.com/dxlufhjua/image/upload/v1756108503/Traditional_Japanese_Pagoda_Surrounded_by_Cherry_Blossoms_at_Sunset_with_Majestic_Mountain_Backdrop_Perfect_for_Travel_Culture_and_Scenic_Landscape_Photography_Stock_Illustration___Adobe_Stock_bxklkp.jpg')",
    ...
    >
      ...
      <div className="relative z-10">
        <h1 
          className="mb-1 md:mb-2 text-xl font-bold md:text-4xl text-white drop-shadow-lg"
          style={{ 
        ...
        <p 
          ...
          style={{ 
            textShadow: "1px 1px 3px rgba(0,0,0,0.7), 0 0 15px rgba(255,255,255,0.4)",
            fontWeight: "600"
          }}
        >
